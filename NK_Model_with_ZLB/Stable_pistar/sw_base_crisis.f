...
c      DO 8010 IV = 1,NDOG                                                 
c      KVAR=KK(IC)+IV
c      read(99,7001) IC,IVV                                              
c      read(99,7501) ( ER(KVAR,IY),IY=1,KAG )                            
c 8010 continue
cC ************* only read to LEXOG-2 because NB and pibar are read 
cC ************* from the data file, not the exogenous file.
c      DO 8020 I=1,LEXOG-2
c 8020 read(98,7501) (X(I,J), J=1,KAG)
c 7001 FORMAT(2I2)                                                    
...
C**************WRITING THE RESIDUALS********************************
      ...
      DO 8010 IV = 1,NDOG                                                 
      WRITE(99,7001) IC,IV                                              
      WRITE(99,7501) ( ER(IV,IY),IY=1,KAG )                            
 8010 continue
      DO 8020 I=1,LEXOG
 8020 WRITE(98,7501) (X(I,J), J=1,KAG)
 7001 FORMAT(2I2)                                                    
 7501 FORMAT(4F30.12)                                                
...
C-----------------------------------------------------------------------
c.....r :
c      IF ( LDOFIX .EQ. 1 ) THEN
c      ER(1,I) = VV(21,1,0) -
c     >( VV(21,38,0)+ONE/((ONE-Z(3)/CGAMMA)
c     >/(Z(2)*(ONE+Z(3)/CGAMMA)))
c     >*((Z(3)/CGAMMA)/(ONE+Z(3)/CGAMMA)*VV(1,7,-1)
c     >+(ONE/(ONE+Z(3)/CGAMMA))*VV(21,18,0)
c     >+((Z(2)-ONE)*CWHLC/(Z(2)*(ONE+Z(3)/CGAMMA)))
c     >*(VV(1,9,0)-VV(21,19,0))+VV(21,23,0)-VV(1,7,0)) )
c      END IF
c      V(1) = VV(21,38,0)+ONE/((ONE-Z(3)/CGAMMA)
c     >/(Z(2)*(ONE+Z(3)/CGAMMA)))
c     >*((Z(3)/CGAMMA)/(ONE+Z(3)/CGAMMA)*VV(1,7,-1)
c     >+(ONE/(ONE+Z(3)/CGAMMA))*VV(21,18,0)
c     >+((Z(2)-ONE)*CWHLC/(Z(2)*(ONE+Z(3)/CGAMMA)))
...
C      IF ( LDOFIX .EQ. 1 ) THEN
C      ER(5,I) = VV(21,5,0) -
C     > ( (VV(1,1,0)-Z(12)*VV(1,1,-1)-Z(13)*(ONE-Z(12))*VV(1,8,0)
C     >-Z(14)*(VV(1,8,0)-VV(1,8,-1))-VV(21,25,0))/(Z(11)*(ONE-Z(12))) )
C      END IF
...
C      IF ( LDOFIX .EQ. 1 ) THEN
C      ER(5,I) = VV(21,5,0) -
C     > ( ((((VV(1,10,0)-(ONE-Z(17))*((ONE-Z(15))/Z(15)*(-VV(1,6,0))
C     >+VV(21,26,0)/Z(15)))/Z(17))*Z(15)+(ONE-Z(15))*VV(1,6,0)
C     >-VV(21,26,0))*(((ONE-Z(6))*(ONE-CBETABAR*CGAMMA*Z(6))/Z(6))
C     >/((Z(10)-ONE)*CURVP+ONE))+(CBETABAR*CGAMMA*VV(21,38,0)
C     >+Z(8)*VV(1,5,-1)))*(ONE/(ONE+CBETABAR*CGAMMA*Z(8)))+VV(21,27,0) )
C      END IF
C      V(5) = ((((VV(1,10,0)-(ONE-Z(17))*((ONE-Z(15))/Z(15)*(-VV(1,6,0))
C     >+VV(21,26,0)/Z(15)))/Z(17))*Z(15)+(ONE-Z(15))*VV(1,6,0)
C     >-VV(21,26,0))*(((ONE-Z(6))*(ONE-CBETABAR*CGAMMA*Z(6))/Z(6))
C     >/((Z(10)-ONE)*CURVP+ONE))+(CBETABAR*CGAMMA*VV(21,38,0)
C     >+Z(8)*VV(1,5,-1)))*(ONE/(ONE+CBETABAR*CGAMMA*Z(8)))+VV(21,27,0)
C     >+RR(1,5,0)
      ...
      IF ( LDOFIX .EQ. 1 ) THEN
      ER(5,I) = VV(21,5,0) -
     > ( Z(8)*(ONE/(ONE+CBETABAR*GAMMA*Z(8)))*VV(1,5,-1)
!     >+((CBETABAR*CGAMMA)/(ONE+CBETABAR*CGAMMA*Z(8)))*VV(21,38,0)
     >+((CBETABAR*CGAMMA)/(ONE+CBETABAR*CGAMMA*Z(8)))*PISTAR
     >-(ONE/Z(17))*( (ONE/(1+CBETABAR*CGAMMA*Z(8)))
     >*(((ONE-CBETABAR*CGAMMA*Z(6))
     >*(ONE-Z(6)))/(Z(6)*((Z(10)-ONE)*CURVP+ONE)))
     >*(Z(15)*(VV(1,6,0)-VV(1,10,0))+VV(21,26,0)-VV(1,6,0)) ) 
     >+VV(21,27,0) )
      END IF
      V(5) = Z(8)*(ONE/(ONE+CBETABAR*GAMMA*Z(8)))*VV(1,5,-1)
!     >+((CBETABAR*CGAMMA)/(ONE+CBETABAR*CGAMMA*Z(8)))*VV(21,38,0)
     >+((CBETABAR*CGAMMA)/(ONE+CBETABAR*CGAMMA*Z(8)))*PISTAR
     >-(ONE/Z(17))*( (ONE/(1+CBETABAR*CGAMMA*Z(8)))
     >*(((ONE-CBETABAR*CGAMMA*Z(6))
...
c      IF ( LDOFIX .EQ. 1 ) THEN
c      ER(5,I) = VV(21,5,0) -
c     > ( ((VV(1,10,0)*Z(15)-VV(21,26,0)+(ONE-Z(15))*VV(1,6,0))
c     >*(((ONE-Z(8))*(ONE-CBETABAR*CGAMMA*Z(8))/Z(8))
c     >/((Z(10)-ONE)*CURVP+ONE))
c     >+(CBETABAR*CGAMMA*VV(21,38,0)+Z(8)*VV(1,5,-1)))
c     >*(ONE/(ONE+CBETABAR*CGAMMA*Z(8)))+VV(21,27,0) )
c      END IF
c      V(5) = ((VV(1,10,0)*Z(15)-VV(21,26,0)+(ONE-Z(15))*VV(1,6,0))
c     >*(((ONE-Z(8))*(ONE-CBETABAR*CGAMMA*Z(8))/Z(8))
c     >/((Z(10)-ONE)*CURVP+ONE))
c     >+(CBETABAR*CGAMMA*VV(21,38,0)+Z(8)*VV(1,5,-1)))
c     >*(ONE/(ONE+CBETABAR*CGAMMA*Z(8)))+VV(21,27,0)
...
!     >+((CBETABAR*CGAMMA)/(ONE+CBETABAR*CGAMMA))*VV(21,38,0)
     >+((CBETABAR*CGAMMA)/(ONE+CBETABAR*CGAMMA))*PISTAR
     >+((ONE-Z(4))
     >*((ONE-CBETABAR*CGAMMA*Z(4))/((ONE+CBETABAR*CGAMMA)*Z(4)))
     >*(ONE/((CLANDAW-ONE)*CURVW+ONE)))
...
C      IF ( LDOFIX .EQ. 1 ) THEN
C      ER(7,I) = VV(21,7,0) -
C     > ( (VV(1,8,0)-CIY*VV(1,2,0)-VV(21,22,0)
C     >-ONE*CRKKY*(ONE/(Z(9)/(ONE-Z(9))))*VV(1,10,0)
C     >-0.01*VV(1,13,0))/CCY )
C      END IF
C      V(7) = (VV(1,8,0)-CIY*VV(1,2,0)-VV(21,22,0)
C     >-ONE*CRKKY*(ONE/(Z(9)/(ONE-Z(9))))*VV(1,10,0)
C     >-0.01*VV(1,13,0))/CCY
C     >+RR(1,7,0)
      ...
      IF ( LDOFIX .EQ. 1 ) THEN
      ER(7,I) = VV(21,7,0) -
!     > ( -(VV(1,1,0)-VV(21,38,0))*((ONE-Z(3)/CGAMMA)
     > ( -(VV(1,1,0)-PISTAR)*((ONE-Z(3)/CGAMMA)
     >/(Z(2)*(ONE+Z(3)/CGAMMA)))
     >+(Z(3)/CGAMMA)/(ONE+Z(3)/CGAMMA)*VV(1,7,-1)
     >+(ONE/(ONE+Z(3)/CGAMMA))*VV(21,18,0)
     >+((Z(2)-ONE)*CWHLC/(Z(2)*(ONE+Z(3)/CGAMMA)))
     >*(VV(1,9,0)-VV(21,19,0))+VV(21,23,0) )
      END IF
!      V(7) = -(VV(1,1,0)-VV(21,38,0))*((ONE-Z(3)/CGAMMA)
      V(7) = -(VV(1,1,0)-PISTAR)*((ONE-Z(3)/CGAMMA)
     >/(Z(2)*(ONE+Z(3)/CGAMMA)))
     >+(Z(3)/CGAMMA)/(ONE+Z(3)/CGAMMA)*VV(1,7,-1)
     >+(ONE/(ONE+Z(3)/CGAMMA))*VV(21,18,0)
     >+((Z(2)-ONE)*CWHLC/(Z(2)*(ONE+Z(3)/CGAMMA)))
...
C      IF ( LDOFIX .EQ. 1 ) THEN
C      ER(8,I) = VV(21,8,0) -
C     > ( Z(10)*(Z(15)*(VV(1,4,-1)
C     >+(ONE/(Z(9)/(ONE-Z(9))))*VV(1,10,0))
C     >+(ONE-Z(15))*VV(1,9,0)+VV(21,26,0)) )
C      END IF
C      V(8) = Z(10)*(Z(15)*(VV(1,4,-1)
C     >+(ONE/(Z(9)/(ONE-Z(9))))*VV(1,10,0))
C     >+(ONE-Z(15))*VV(1,9,0)+VV(21,26,0))
C     > +RR(1,8,0)
      IF ( LDOFIX .EQ. 1 ) THEN
      ER(8,I) = VV(21,8,0) -
     > ( CCY*VV(1,7,0)+CIY*VV(1,2,0)+VV(21,22,0)
     >+CRKKY*(ONE/(Z(9)/(ONE-Z(9))))*VV(1,10,0)
     >+0.01*VV(1,13,0) )
      END IF
      V(8) = CCY*VV(1,7,0)+CIY*VV(1,2,0)+VV(21,22,0)
     >+CRKKY*(ONE/(Z(9)/(ONE-Z(9))))*VV(1,10,0)
     >+0.01*VV(1,13,0)
     >+RR(1,8,0)
c      v(8)=vv(21,8,0)
...
c.....RK :
C      IF ( LDOFIX .EQ. 1 ) THEN
C      ER(10,I) = VV(21,10,0) -
C     > ( Z(17)*((((VV(1,5,0)-VV(21,27,0))/
C     >(ONE/(ONE+CBETABAR*CGAMMA*Z(8)))
C     >-(CBETABAR*CGAMMA*VV(21,38,0)+Z(8)*VV(1,5,-1)))/
C     >(((ONE-Z(6))*(ONE-CBETABAR*CGAMMA*Z(6))/Z(6))
C     >/((Z(10)-ONE)*CURVP+ONE))
C     >-(ONE-Z(15))*VV(1,6,0)+VV(21,26,0))/Z(15))
C     >+(ONE-Z(17))*((1-Z(15))/Z(15)*(-VV(1,6,0))+VV(21,26,0)/Z(15)) )
C      END IF
C      V(10) = Z(17)*((((VV(1,5,0)-VV(21,27,0))/
C     >(ONE/(ONE+CBETABAR*CGAMMA*Z(8)))
C     >-(CBETABAR*CGAMMA*VV(21,38,0)+Z(8)*VV(1,5,-1)))/
C     >(((ONE-Z(6))*(ONE-CBETABAR*CGAMMA*Z(6))/Z(6))
C     >/((Z(10)-ONE)*CURVP+ONE))
...
C     >+RR(1,10,0)
      ...
      ER(10,I) = VV(21,10,0) -
     > ( ((VV(1,8,0)/Z(10)
     >-(ONE-Z(15))*VV(1,9,0)-VV(21,26,0))/Z(15)
     >-VV(1,4,-1))*(Z(9)/(ONE-Z(9))) )
      END IF
      V(10) = ((VV(1,8,0)/Z(10)
     >-(ONE-Z(15))*VV(1,9,0)-VV(21,26,0))/Z(15)
     >-VV(1,4,-1))*(Z(9)/(ONE-Z(9)))
...
!     > ( VV(1,11,-1)+(VV(1,1,-1)-VV(21,38,-1)) )
     > ( VV(1,11,-1)+(VV(1,1,-1)-PISTAR) )
      END IF
!      V(12) = VV(1,11,-1)+(VV(1,1,-1)-VV(21,38,-1))
      V(12) = VV(1,11,-1)+(VV(1,1,-1)-PISTAR)
     > +RR(1,12,0)
c      V(12)=ZERO
C-----------------------------------------------------------------------
c..... n:
...
c..... MZERO:
c      IF ( LDOFIX .EQ. 1 ) THEN
c      ER(15,I) = VV(21,33,0) - 
c     > ( VV(1,15,-1)+Z(20)*(VV(1,16,0)-VV(1,16,-1))+VV(21,32,0) ) 
c      END IF
c      V(15) = VV(1,15,-1)+Z(20)*(VV(1,16,0)-VV(1,16,-1))+VV(21,32,0)
c     >+RR(1,15,0)
      IF ( LDOFIX .EQ. 1 ) THEN
      ER(15,I) = VV(21,34,0) - 
     > ( VV(1,15,-1)+Z(19)*VV(1,11,0)+VV(21,33,0) )
      END IF
      V(15) = VV(1,15,-1)+Z(19)*VV(1,11,0)+VV(21,33,0)
     >+RR(1,15,0)
C-----------------------------------------------------------------------
c..... MTWO:
      IF ( LDOFIX .EQ. 1 ) THEN
